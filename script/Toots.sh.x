...
cd $WORK_DIR
wget -O docker-compose.yml.tpl https://raw.githubusercontent.com/CloudNil/PanteraS/master/docker-compose.yml.tpl
wget -O generate_yml.sh https://raw.githubusercontent.com/CloudNil/PanteraS/master/generate_yml.sh
